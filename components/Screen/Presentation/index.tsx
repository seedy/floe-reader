			...
			<Content
				...
				longCatcher={
					<>
						...
						<P>
							Je définis ton client idéal ainsi que le message qui attirera son
							attention, de manière transparente et authentique.
						</P>
					</>
				}
				catcher={
			...
			>
				<div className="mt-[1.875rem] flex flex-col justify-between gap-32">
					...
					<P>
						...
						captivante et humaine ? Prenons le temps d&apos;étudier ton audience
						pour{" "}
						<span className="font-bold">
			...
			<Content
				...
				longSubtitle={
					<>
						...
						mettre en lumière des projets inspirants grâce à mes compétences en
						SEO et en copywriting.
					</>
				}
				subtitle={
					<>
						<span className="font-bold underline">«Depuis des Lunes»</span>, un
				...
				longCatcher={
					<>
						...
						<P>
							...
							pour la prise de son. J&apos;ai de l&apos;expérience en interview.
							Je peux ainsi te proposer une prestation complète.
						</P>
					</>
				}
				catcher={
				...
				<div className="mt-[1.875rem] flex flex-col justify-between gap-32">
					<div className="flex flex-col lg:gap-3">
						...
						<P>
							...
							<br />
							<br />
							Des témoignagnes poignants et émouvants pour raconter ce qui ne se
							raconte pas.
						</P>
					</div>
					<div className="flex flex-col lg:gap-3">
