	...
	return (
		<Screen>
			<Box className={styles.videoBlock}>
				<H1 className={classNames(styles.heading, styles.appear)}>
					Ensemble, réalisons les contenus qui feront parler de toi
				</H1>
				...
				<ButtonLink
					variant="contained"
					href={CALENDLY}
					className={classNames(styles.cta, styles.desktop, styles.appear)}
				>
					Planifier un RDV
				</ButtonLink>
				<Logo
					...
					priority
					src={cbcLogo}
					className={classNames(styles.logo, styles.appear)}
				/>
			</Box>
			<Flex className={styles.presentation}>
				...
				<Logo
					...
					priority
					src={cbcSign}
					className={classNames(styles.sign, styles.desktop)}
				/>
			</Flex>
			<Flex className={styles.links}>
				<Logo
					...
					priority
					src={cbcSign}
					className={classNames(styles.sign, styles.mobile)}
				/>
				<Socials />
				<ButtonLink
					variant="contained"
