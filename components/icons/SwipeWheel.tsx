...
const SwipeWheel = (props: ComponentProps<"svg">) => (
  <svg
    {...props}
    width="17"
    height="12"
    ...
    <defs>
      <clipPath id="clip0_120_317">
        <rect
          ...
          height="16.562"
          fill="white"
          transform="matrix(0 1 -1 0 16.562 0)"
        />
      </clipPath>
    </defs>
  </svg>
