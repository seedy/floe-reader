...
const ShareDropdown = ({ open, onOpenChange, onQrCodeOpen, onShareMail, onCopyLink, trigger, children }: ShareDropdownProps) => (
    <Root open={open} onOpenChange={onOpenChange}>
        <Trigger asChild>
            {trigger}
        </Trigger>
        <Content className={styles.content} collisionPadding={{ top: 20, right: 20 }}>
            <Label asChild>
