...
import { Root, Trigger, Overlay, Content, Title, Close, Description } from "@radix-ui/react-dialog"
...
const ShareLocked = ({ open, onOpenChange, onUnlocked, onError, children }: ShareLockedProps) => {
